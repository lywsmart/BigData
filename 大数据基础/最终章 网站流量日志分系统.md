...
1. 创建[WebLogMap]()类，并重写[map方法()]()，创建[dateFotmatLog对象]()和[dateFormat对象]()。
   ...
   <img src="./最终章 网站流量日志分系统.assets/image-20231227165009081.png" alt="image-20231227165009081" />
...
1. 创建[WebLogDriver]()类，并定义main()方法，创建dateFormat对象，并获取date对象
   ...
   ![image-20231227165652553](./最终章 网站流量日志分系统.assets/image-20231227165652553.png)
...
<img src="./最终章 网站流量日志分系统.assets/image-20231226110454865.png" alt="image-20231226110454865" />
